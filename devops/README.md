...
```
DEPLOY_ENV=prod
DEPLOY_HOST=project-title.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for project-title.example.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    project-title.example.com:
      ansible_user: root
      host: project-title
      hostname: project-title.example.com
```
...
Deploy the stack defined in `devops/stacks/project-title.example.com.yml` to the remote server with:
